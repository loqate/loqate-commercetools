...
type GetCartAction = (options?: { serverOptions?: ServerOptions }) => Promise<SDKResponse<Cart>>;
...
type GetCheckoutSessionTokenAction = (options?: { serverOptions?: ServerOptions }) => Promise<SDKResponse<Token>>;
