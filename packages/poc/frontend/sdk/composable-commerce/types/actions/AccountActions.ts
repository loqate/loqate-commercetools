...
type GetAccountAction = (options?: { serverOptions?: ServerOptions }) => Promise<SDKResponse<GetAccountActionReturn>>;
...
type LogoutAccountAction = (options?: { serverOptions?: ServerOptions }) => Promise<SDKResponse<void>>;
