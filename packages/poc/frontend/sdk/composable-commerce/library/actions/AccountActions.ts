...
export const getAccountActions = (sdk: SDK<ComposableCommerceEvents>): AccountActions => {
  return {
    ...
    login: async (payload: LoginAccountPayload, options: { serverOptions?: ServerOptions } = {}) => {
    ...
    register: async (payload: RegisterAccountPayload, options: { serverOptions?: ServerOptions } = {}) => {
      const response = await sdk.callAction<Account>({
    ...
    confirm: async (payload: ConfirmAccountPayload, options: { serverOptions?: ServerOptions } = {}) => {
      const response = await sdk.callAction<Account>({
    ...
    changePassword: async (payload: ChangeAccountPasswordPayload, options: { serverOptions?: ServerOptions } = {}) => {
      const response = await sdk.callAction<Account>({
    ...
    resetPassword: async (payload: ResetAccountPasswordPayload, options: { serverOptions?: ServerOptions } = {}) => {
      const response = await sdk.callAction<Account>({
    ...
    updateAccount: async (payload: UpdateAccountPayload, options: { serverOptions?: ServerOptions } = {}) => {
      const response = await sdk.callAction<Account>({
    ...
    addAddress: async (payload: AddAccountAddressPayload, options: { serverOptions?: ServerOptions } = {}) => {
      const response = await sdk.callAction<Account>({
    ...
    updateAddress: async (payload: UpdateAccountAddressPayload, options: { serverOptions?: ServerOptions } = {}) => {
      const response = await sdk.callAction<Account>({
    ...
    removeAddress: async (payload: RemoveAccountAddressPayload, options: { serverOptions?: ServerOptions } = {}) => {
      const response = await sdk.callAction<Account>({
