...
export const getCartActions = (sdk: SDK<ComposableCommerceEvents>): CartActions => {
  return {
    ...
    addItem: async (payload: AddCartItemPayload, options: { serverOptions?: ServerOptions } = {}) => {
      const response = await sdk.callAction<Cart>({
    ...
    removeItem: async (payload: RemoveCartItemPayload, options: { serverOptions?: ServerOptions } = {}) => {
      const response = await sdk.callAction<Cart>({
    ...
    updateItem: async (payload: UpdateCartItemPayload, options: { serverOptions?: ServerOptions } = {}) => {
      const response = await sdk.callAction<Cart>({
    ...
    updateCart: async (payload: UpdateCartPayload, options: { serverOptions?: ServerOptions } = {}) => {
      const response = await sdk.callAction<Cart>({
    ...
    getAvailableShippingMethods: async (options: { serverOptions?: ServerOptions } = {}) => {
      const response = await sdk.callAction<ShippingMethod[]>({
    ...
    redeemDiscountCode: async (payload: RedeemDiscountCodePayload, options: { serverOptions?: ServerOptions } = {}) => {
    ...
    removeDiscountCode: async (payload: RemoveDiscountCodePayload, options: { serverOptions?: ServerOptions } = {}) => {
      const response = await sdk.callAction<Cart>({
    ...
    checkout: async (payload: CheckoutCartPayload, options: { serverOptions?: ServerOptions } = {}) => {
      const response = await sdk.callAction<Cart>({
